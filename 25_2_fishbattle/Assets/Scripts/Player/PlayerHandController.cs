...
public class PlayerHandController : MonoBehaviour
{
    ...
    // 카드 포커스 시: 1.0 * 1.6 = 1.6 (화면에 꽉 차게 확대)
    ...
    // [수정됨] 포커스 위치 (Y축 적당히, Z축으로 카메라에 가깝게 당김)
    ...
    private void Start()
    {
        // CardManager 설정 전이라도 기본값 0.3 적용
    ...
    public void HandleMouseClick()
    {
        ...
        if (Physics.Raycast(ray, out hit))
        {
            ...
            // 손패에 있는 개별 카드(PlayerCard)를 클릭했을 때
