...
public class GameMultiManager : NetworkBehaviour
{
    private static GameMultiManager _instance;
    public static GameMultiManager Instance
    {
        get
        {
            if (_instance == null)
            {
                _instance = FindObjectOfType<GameMultiManager>();
            }
            return _instance;
        }
    }
